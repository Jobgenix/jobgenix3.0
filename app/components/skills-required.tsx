  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-4 bg-[#F3FFF4]">
      <div className="space-y-6">
        {/* Title Section */}
        <div>
          <h2 className="text-[#2E7D32] text-xl font-medium inline-flex items-center gap-1">
            Skills Required: <span className="text-red-500">*</span>
          </h2>
          <p className="text-gray-600 mt-1 text-sm">Add the eligibility criteria to better filter the candidates.</p>
        </div>

        {/* Toggle Switches */}
        <div className="space-y-4">
          <div className="bg-white rounded-xl p-4 shadow-[0_2px_8px_rgba(0,0,0,0.08)] flex items-center justify-between">
            <span className="text-gray-800 font-medium">Open for college students (currently studying)</span>
            <Switch
          ...
          <div className="bg-white rounded-xl p-4 shadow-[0_2px_8px_rgba(0,0,0,0.08)] flex items-center justify-between">
            <span className="text-gray-800 font-medium">Any specific course/ specialization/ graduating year</span>
            <Switch

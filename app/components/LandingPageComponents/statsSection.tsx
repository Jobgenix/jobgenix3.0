      ...
      <section className="bg-white from-green-50 to-green-100 py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-emerald-600"><span className="text-black">1.3K</span>+</p>
              <p className="text-sm md:text-base text-gray-600">Impressions</p>
            </div>
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-emerald-600"><span className="text-black">200</span>+</p>

...
export default function CareerButtons() {
  return (
    <div className="flex flex-col w-full items-center gap-4 p-6  mx-auto md:hidden bg-gradient-to-r from-[#C6F7D5] to-[#FFFCEF] ">
      <button className="group flex flex-col items-center p-4 bg-[#F9E39E] w-4/5 rounded-2xl hover:shadow-lg transition-all duration-300">
      ...
      <button className="group flex flex-col items-center p-4 bg-[#D5CDFD] w-4/5 rounded-2xl hover:shadow-lg transition-all duration-300">
        <div className="flex items-center gap-2 mb-1">
      ...
      <button className="group flex flex-col items-center p-4 bg-[#EBCABFF7] w-4/5 rounded-2xl hover:shadow-lg transition-all duration-300">
        <div className="flex items-center gap-2 mb-1">

        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-emerald-600">1K+</p>
              <p className="text-sm md:text-base text-gray-600">Active Users</p>
            </div>
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-emerald-600">500+</p>
              <p className="text-sm md:text-base text-gray-600">Opportunities</p>
            </div>
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-emerald-600">150+</p>
              <p className="text-sm md:text-base text-gray-600">Brands trust us</p>
            </div>
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-emerald-600">1</p>

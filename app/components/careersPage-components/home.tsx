  ...
  return (
    <div className="overflow-x-hidden ">
      ...
      <div className="main1 h-screen bg-[#e5f7eb] overflow-x-hidden relative">
        ...
        <Image
          src="/images2/women-removebg-preview.png"
          className="absolute  top-28 z-0 lg:h-[60vh] xl:ml-[35%]  lg:right-16 md:h-[40vh] md:left-80"
          alt="image"
          height={500}
          width={500}
        />
        ...
        <Image
          src="/images2/pop-up.png"
          className="md:h-28 absolute md:left-[70%] right-16 xl:mt-[-5%] xl:ml-[10%] top-[60%] z-10 lg:right-6 md:mt-[-15%]   "
          alt="image"
          height={230}
          width={230}
        />

        <div className="offers space-y-2 p-2 absolute top-40 right-1/3 md:ml-[-20%]">
          <div className="o1 h-8 w-28 shadow-lg rounded-lg bg-[#EBE7FD] p-1 text-center ml-[-8%] transform rotate-x-6 rotate-y-6 shadow-gray-400">
            <p className="mt-1 text-xs">SDE Intern</p>
          </div>
          <div className="o2 h-8 w-36 shadow-lg rounded-lg bg-[#FFF8DE] p-1 text-center ml-6 transform rotate-x-[-6deg] rotate-y-[-6deg] shadow-gray-500">
            <p className="mt-1 text-xs">Business Associate</p>
          </div>
          <div className="o3 h-8 w-32 shadow-lg rounded-lg bg-[#fdebe5] p-1 text-center ml-[-8%] transform rotate-x-6 rotate-y-6 shadow-gray-400">
            <p className="mt-1 text-xs">Product Manager</p>
          </div>
          <div className="o4 h-8 w-20 shadow-lg rounded-lg bg-[#bedbf8] p-0.5 text-center ml-16 transform rotate-x-[-6deg] rotate-y-[-6deg] shadow-gray-500">
            <p className="mt-1 text-xs">Video Editor</p>
          </div>
        </div>
        ...
        <div className="text p-52 mt-[-2%] md:ml-[-20%] xl:ml-4">
          <h1 className="xl:text-6xl lg:text-4xl font-bold md:text-2xl ">
            Careers at <span className="text-[#018e59]">Jobgenix</span>
          </h1>
          <div className="h-1 w-56 ml-2 mt-3 bg-yellow-400"></div>
          <p className="text-xl w-[35%]  mt-5 ml-2">
            Amplify your skills, enrich your CV, and make your dream job a
            reality with global connections.
          </p>
          <button className="bg-[#018e59] text-white p-2 mt-6 ml-2 rounded-lg">
            Apply Now
          </button>
        </div>
      </div>
      ...
      <div className="main2 h-auto bg-[#e5f7eb] overflow-x-hidden">
        ...
        <div className="flex h-28 md:h-32 w-[45%] mx-auto mb-56 lg:w-[40%] bg-[#C6F7D5] mt-20 rounded-2xl md:w-[70%]">
          <Image
            src="/images2/women-laptop.png"
            alt="image"
            height={150}

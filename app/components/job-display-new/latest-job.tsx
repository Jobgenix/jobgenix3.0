...
export default function JobSearchInterface() {
  ...
  return (
    <div className="min-h-screen bg-sky-50 md:mt-14 xl:mt-[-2%]">
          ...
          <div className="lg:px-[4%] xl:ml-[12%] xl:px-0 flex md:flex-row flex-col gap-y-2 items-left gap-4 ">
            ...
            <div className="relative flex md:w-[700px] ">
              ...
              <input
                ...
                {...register("search")}
                className="w-full h-10 pl-10 pr-4 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>

            <div className="nextline flex gap-2 items-center w-full md:w-fit md:mt-0">
              {/* Passing Year Select */}
              <div className="flex w-[180px]">
                <select
                  {...register("passingYear")}
                  className="h-10 w-full  text-gray-400  px-4 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                >
              ...
              <div className="flex items-center gap-4 ">
                <div className="w-[136px]">
                  <select
                    {...register("course")}
                    className="h-10 w-full px-4 text-center text-gray-400 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                  >
                ...
                <div className="md:w-auto">
                  <button
                    type="submit"
                    className="w-fit md:w-auto bg-[#005DB9] text-white px-5 py-2 rounded-md hover:bg-blue-700 transition-colors"
                  >
                    Apply
                  </button>
                </div>
      ...
      <h1 className="xl:text-2xl xl:ml-[25%] ml-[8%] text-xl bg-[#f9fafb] font-semibold">
        All Jobs
      </h1>
      <Home2 />

...
export default function JoBDet({job}: { job: Job }) {
  return (
    <div className="bg-white min-h-screen p-4">
      <div className="max-w-6xl mx-auto grid md:grid-cols-[300px_1fr] gap-4" >
        {/* Job Card */}
        <div className="bg-[#F5F5F5] rounded-xl p-5 shadow-sm h-fit " style={{ boxShadow: "1px 1px 2px 0px rgba(255, 255, 255, 0.30) inset, -1px -1px 2px 0px rgba(200, 200, 200, 0.50) inset, -6px 6px 12px 0px rgba(200, 200, 200, 0.20), 6px -6px 12px 0px rgba(200, 200, 200, 0.20), -6px -6px 12px 0px rgba(255, 255, 255, 0.90), 6px 6px 15px 0px rgba(200, 200, 200, 0.90)" }}>
  ...
  <div className="absolute inset-0 z-0">
    <Image src="/images2/blue-card.png" alt="frame98" fill className="object-cover opacity-50 " />
  </div>
